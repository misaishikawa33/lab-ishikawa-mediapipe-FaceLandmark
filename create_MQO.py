...
class CreateMQO:
    ...
    def set_point(self, texture_filename):
        ...
        datalist1 = [7, 33, 133, 144, 145, 153, 154, 155, 157, 158, 159, 160, 161, 163, 173, 246,249, 263, 362, 373, 374, 380, 381, 382, 384, 385, 386, 387, 388, 390, 398, 466,234,227, 137, 132, 58, 172, 136, 150, 149, 176, 148, 152]
